...
public class AquaticFeatures {
   ...
   public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> p_256171_) {
      FeatureUtils.register(p_256171_, SEAGRASS_SHORT, Feature.SEAGRASS, new ProbabilityFeatureConfiguration(0.3F));
      FeatureUtils.register(p_256171_, SEAGRASS_SLIGHTLY_LESS_SHORT, Feature.SEAGRASS, new ProbabilityFeatureConfiguration(0.4F));
      FeatureUtils.register(p_256171_, SEAGRASS_MID, Feature.SEAGRASS, new ProbabilityFeatureConfiguration(0.6F));
      FeatureUtils.register(p_256171_, SEAGRASS_TALL, Feature.SEAGRASS, new ProbabilityFeatureConfiguration(0.8F));
      FeatureUtils.register(p_256171_, SEA_PICKLE, Feature.SEA_PICKLE, new CountConfiguration(20));
      FeatureUtils.register(p_256171_, SEAGRASS_SIMPLE, Feature.SIMPLE_BLOCK, new SimpleBlockConfiguration(BlockStateProvider.simple(Blocks.SEAGRASS)));
      FeatureUtils.register(p_256171_, KELP, Feature.KELP);
      FeatureUtils.register(p_256171_, WARM_OCEAN_VEGETATION, Feature.SIMPLE_RANDOM_SELECTOR, new SimpleRandomFeatureConfiguration(HolderSet.direct(PlacementUtils.inlinePlaced(Feature.CORAL_TREE, FeatureConfiguration.NONE), PlacementUtils.inlinePlaced(Feature.CORAL_CLAW, FeatureConfiguration.NONE), PlacementUtils.inlinePlaced(Feature.CORAL_MUSHROOM, FeatureConfiguration.NONE))));
   }
}