...
public class EndFeatures {
   ...
   public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> p_256286_) {
      FeatureUtils.register(p_256286_, END_SPIKE, Feature.END_SPIKE, new SpikeConfiguration(false, ImmutableList.of(), (BlockPos)null));
      FeatureUtils.register(p_256286_, END_GATEWAY_RETURN, Feature.END_GATEWAY, EndGatewayConfiguration.knownExit(ServerLevel.END_SPAWN_POINT, true));
      FeatureUtils.register(p_256286_, END_GATEWAY_DELAYED, Feature.END_GATEWAY, EndGatewayConfiguration.delayedExitSearch());
      FeatureUtils.register(p_256286_, CHORUS_PLANT, Feature.CHORUS_PLANT);
      FeatureUtils.register(p_256286_, END_ISLAND, Feature.END_ISLAND);
   }
}