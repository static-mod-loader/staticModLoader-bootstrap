...
public class ChunkStructuresTemplateRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ChunkStructuresTemplateRenameFix", type, (p_274927_) -> {
         return p_274927_.update(DSL.remainderFinder(), this::fixChildren);
      });
   }

   private Dynamic<?> fixChildren(Dynamic<?> p_275363_) {
      return p_275363_.update("Children", (p_274926_) -> {
         return p_275363_.createList(p_274926_.asStream().map((p_274924_) -> {
            return this.fixTag(p_275363_, p_274924_);
         }));
      });
   }
