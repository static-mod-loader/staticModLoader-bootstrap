...
public class ClampedInt extends IntProvider {
   ...
   }).comapFlatMap((p_274932_) -> {
      return p_274932_.maxInclusive < p_274932_.minInclusive ? DataResult.error(() -> {
         return "Max must be at least min, min_inclusive: " + p_274932_.minInclusive + ", max_inclusive: " + p_274932_.maxInclusive;
