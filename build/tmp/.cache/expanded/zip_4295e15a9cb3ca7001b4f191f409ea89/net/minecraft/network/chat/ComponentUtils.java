...
public class ComponentUtils {
   ...
   public static Component fromMessage(Message p_130730_) {
      return (Component)(p_130730_ instanceof Component ? (Component)p_130730_ : Component.literal(p_130730_.getString()));
   }
   ...
   public static MutableComponent copyOnClickText(String p_260039_) {
      return wrapInSquareBrackets(Component.literal(p_260039_).withStyle((p_258207_) -> {
         return p_258207_.withColor(ChatFormatting.GREEN).withClickEvent(new ClickEvent(ClickEvent.Action.COPY_TO_CLIPBOARD, p_260039_)).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, Component.translatable("chat.copy.click"))).withInsertion(p_260039_);
      }));
   }
}