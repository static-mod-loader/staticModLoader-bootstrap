         ...
         return new AbstractIterator<BlockPos>() {
            ...
            protected BlockPos computeNext() {
               if (this.counter <= 0) {
                  ...
                  BlockPos blockpos = this.nextPos.set(p_235644_ + p_235642_.nextInt(i), p_235645_ + p_235642_.nextInt(j), p_235646_ + p_235642_.nextInt(k));
                  --this.counter;
                  return blockpos;
               }
            }
   ...
   public static int breadthFirstTraversal(BlockPos p_278078_, int p_277385_, int p_277666_, BiConsumer<BlockPos, Consumer<BlockPos>> p_277755_, Predicate<BlockPos> p_278094_) {
      ...
      while(!queue.isEmpty()) {
         ...
         if (longset.add(k) && p_278094_.test(blockpos)) {
            ...
            if (j < p_277385_) {
               p_277755_.accept(blockpos, (p_277234_) -> {
