...
public class Vec3i implements Comparable<Vec3i> {
   ...
   public static Codec<Vec3i> offsetCodec(int p_194651_) {
      return ExtraCodecs.validate(CODEC, (p_274739_) -> {
         return Math.abs(p_274739_.getX()) < p_194651_ && Math.abs(p_274739_.getY()) < p_194651_ && Math.abs(p_274739_.getZ()) < p_194651_ ? DataResult.success(p_274739_) : DataResult.error(() -> {
            return "Position out of range, expected at most " + p_194651_ + ": " + p_274739_;
         });
      });
   }
