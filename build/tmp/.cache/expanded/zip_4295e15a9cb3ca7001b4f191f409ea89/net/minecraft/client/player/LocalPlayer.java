...
public class LocalPlayer extends AbstractClientPlayer {
   ...
   public void playSound(SoundEvent p_108651_, float p_108652_, float p_108653_) {
      ...
      net.minecraftforge.event.PlayLevelSoundEvent.AtEntity event = net.minecraftforge.event.ForgeEventFactory.onPlaySoundAtEntity(this, holder, this.getSoundSource(), p_108652_, p_108653_);
