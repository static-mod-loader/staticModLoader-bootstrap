   ...
   protected void setupRotations(Panda p_115641_, PoseStack p_115642_, float p_115643_, float p_115644_, float p_115645_) {
      ...
      if (p_115641_.rollCounter > 0) {
         ...
         if (i < 8) {
            ...
            p_115642_.translate(0.0F, (f1 + 0.2F) * (f2 / 90.0F), 0.0F);
            p_115642_.mulPose(Axis.XP.rotationDegrees(-f2));
         } else if (i < 16) {
            ...
            p_115642_.translate(0.0F, f1 + 0.2F + (f1 - 0.2F) * (f10 - 90.0F) / 90.0F, 0.0F);
            p_115642_.mulPose(Axis.XP.rotationDegrees(-f10));
            ...
            p_115642_.translate(0.0F, f1 + f1 * (270.0F - f11) / 90.0F, 0.0F);
            ...
            p_115642_.translate(0.0F, f1 * ((360.0F - f12) / 90.0F), 0.0F);
      ...
      if (f6 > 0.0F) {
         p_115642_.translate(0.0F, 0.8F * f6, 0.0F);
         p_115642_.mulPose(Axis.XP.rotationDegrees(Mth.lerp(f6, p_115641_.getXRot(), p_115641_.getXRot() + 90.0F)));
         p_115642_.translate(0.0F, -1.0F * f6, 0.0F);
         if (p_115641_.isScared()) {
            float f7 = (float)(Math.cos((double)p_115641_.tickCount * 1.25D) * Math.PI * (double)0.05F);
            p_115642_.mulPose(Axis.YP.rotationDegrees(f7));
            if (p_115641_.isBaby()) {
      ...
      if (f8 > 0.0F) {
         ...
         p_115642_.translate(0.0F, f9 * f8, 0.0F);
         p_115642_.mulPose(Axis.XP.rotationDegrees(Mth.lerp(f8, p_115641_.getXRot(), p_115641_.getXRot() + 180.0F)));
      }
