...
public class RandomBlockMatchTest extends RuleTest {
   public static final Codec<RandomBlockMatchTest> CODEC = RecordCodecBuilder.create((p_259017_) -> {
      return p_259017_.group(BuiltInRegistries.BLOCK.byNameCodec().fieldOf("block").forGetter((p_163766_) -> {
         return p_163766_.block;
      }), Codec.FLOAT.fieldOf("probability").forGetter((p_163764_) -> {
         return p_163764_.probability;
      })).apply(p_259017_, RandomBlockMatchTest::new);
   });
