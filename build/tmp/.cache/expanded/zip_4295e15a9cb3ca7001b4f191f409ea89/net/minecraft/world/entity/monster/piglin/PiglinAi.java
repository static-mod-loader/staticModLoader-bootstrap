...
public class PiglinAi {
   ...
   public static void angerNearbyPiglins(Player p_34874_, boolean p_34875_) {
      ...
      list.stream().filter(PiglinAi::isIdle).filter((p_34881_) -> {
         ...
         if (p_289467_.level().getGameRules().getBoolean(GameRules.RULE_UNIVERSAL_ANGER)) {
            setAngerTargetToNearestTargetablePlayerIfFound(p_289467_, p_34874_);
         } else {
            setAngerTarget(p_289467_, p_34874_);
         }
   ...
   protected static void wasHurtBy(Piglin p_34838_, LivingEntity p_34839_) {
      if (!(p_34839_ instanceof Piglin)) {
         ...
         getAvoidTarget(p_34838_).ifPresent((p_289470_) -> {
            if (p_289470_.getType() != p_34839_.getType()) {
   ...
   protected static void broadcastAngerTarget(AbstractPiglin p_34896_, LivingEntity p_34897_) {
      getAdultPiglins(p_34896_).forEach((p_289474_) -> {
         if (p_34897_.getType() != EntityType.HOGLIN || p_289474_.canHunt() && ((Hoglin)p_34897_).canBeHunted()) {
