   ...
   public static void logCounts() {
      ...
      data.asMap().forEach((p_190888_, p_190889_) -> {
         ...
         p_190889_.featureData().forEach((p_190897_, p_190898_) -> {
            LOGGER.debug(s1 + " " + String.format(Locale.ROOT, "%10d ", p_190898_) + String.format(Locale.ROOT, "%10f ", (double)p_190898_.intValue() / (double)integer.intValue()) + p_190897_.topFeature().flatMap(registry::getResourceKey).map(ResourceKey::location) + " " + p_190897_.feature().feature() + " " + p_190897_.feature());
         });
      });
   }
