...
public record FlatLevelGeneratorPreset(Holder<Item> displayItem, FlatLevelGeneratorSettings settings) {
   public static final Codec<FlatLevelGeneratorPreset> DIRECT_CODEC = RecordCodecBuilder.create((p_259010_) -> {
      return p_259010_.group(RegistryFixedCodec.create(Registries.ITEM).fieldOf("display").forGetter((p_226258_) -> {
