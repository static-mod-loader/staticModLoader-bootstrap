...
public class FrogAi {
   ...
   private static void initIdleActivity(Brain<Frog> p_218591_) {
      p_218591_.addActivityWithConditions(Activity.IDLE, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(0, new AnimalMakeLove(EntityType.FROG, 1.0F)), Pair.of(1, new FollowTemptation((p_218585_) -> {
         return 1.25F;
      })), Pair.of(2, StartAttacking.create(FrogAi::canAttack, (p_218605_) -> {
   ...
   private static void initSwimActivity(Brain<Frog> p_218595_) {
      p_218595_.addActivityWithConditions(Activity.SWIM, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(1, new FollowTemptation((p_218574_) -> {
         return 1.25F;
      })), Pair.of(2, StartAttacking.create(FrogAi::canAttack, (p_218601_) -> {
   ...
   private static void initLaySpawnActivity(Brain<Frog> p_218599_) {
      p_218599_.addActivityWithConditions(Activity.LAY_SPAWN, ImmutableList.of(Pair.of(0, SetEntityLookTargetSometimes.create(EntityType.PLAYER, 6.0F, UniformInt.of(30, 60))), Pair.of(1, StartAttacking.create(FrogAi::canAttack, (p_218597_) -> {
   ...
   private static void initTongueActivity(Brain<Frog> p_218607_) {
      p_218607_.addActivityAndRemoveMemoryWhenStopped(Activity.TONGUE, 0, ImmutableList.of(StopAttackingIfTargetInvalid.create(), new ShootTongue(SoundEvents.FROG_TONGUE, SoundEvents.FROG_EAT)), MemoryModuleType.ATTACK_TARGET);
   }
