...
public class GoatAi {
   ...
   private static final TargetingConditions RAM_TARGET_CONDITIONS = TargetingConditions.forCombat().selector((p_289449_) -> {
      return !p_289449_.getType().equals(EntityType.GOAT) && p_289449_.level().getWorldBorder().isWithinBounds(p_289449_.getBoundingBox());
   });
   ...
   private static void initRamActivity(Brain<Goat> p_149466_) {
      ...
      }, RAM_TARGET_CONDITIONS, 3.0F, (p_287490_) -> {
