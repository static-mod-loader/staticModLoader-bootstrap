...
public enum ItemDisplayContext implements StringRepresentable, net.minecraftforge.common.IExtensibleEnum {
   ...
   public static final Codec<ItemDisplayContext> CODEC = net.minecraft.util.ExtraCodecs.lazyInitializedCodec(() -> net.minecraftforge.registries.ForgeRegistries.DISPLAY_CONTEXTS.get().getCodec());
