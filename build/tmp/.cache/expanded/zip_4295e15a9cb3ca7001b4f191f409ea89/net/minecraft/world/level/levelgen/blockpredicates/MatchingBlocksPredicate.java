...
class MatchingBlocksPredicate extends StateTestingPredicate {
   ...
   public static final Codec<MatchingBlocksPredicate> CODEC = RecordCodecBuilder.create((p_259004_) -> {
      return stateTestingCodec(p_259004_).and(RegistryCodecs.homogeneousList(Registries.BLOCK).fieldOf("blocks").forGetter((p_204693_) -> {
