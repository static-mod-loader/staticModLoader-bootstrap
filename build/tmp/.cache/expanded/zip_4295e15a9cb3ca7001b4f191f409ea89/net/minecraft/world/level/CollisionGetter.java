...
public interface CollisionGetter extends BlockGetter {
   ...
   default boolean collidesWithSuffocatingBlock(@Nullable Entity p_186438_, AABB p_186439_) {
      BlockCollisions<VoxelShape> blockcollisions = new BlockCollisions<>(this, p_186438_, p_186439_, true, (p_286211_, p_286212_) -> {
         return p_286212_;
      });
   ...
   default Optional<BlockPos> findSupportingBlock(Entity p_286468_, AABB p_286792_) {
      ...
      BlockCollisions<BlockPos> blockcollisions = new BlockCollisions<>(this, p_286468_, p_286792_, false, (p_286213_, p_286214_) -> {
         return p_286213_;
      });
