...
public class GeodeBlockSettings {
   ...
   public static final Codec<GeodeBlockSettings> CODEC = RecordCodecBuilder.create((p_158307_) -> {
      ...
      }), TagKey.hashedCodec(Registries.BLOCK).fieldOf("cannot_replace").forGetter((p_204566_) -> {
         return p_204566_.cannotReplace;
      }), TagKey.hashedCodec(Registries.BLOCK).fieldOf("invalid_blocks").forGetter((p_204564_) -> {
