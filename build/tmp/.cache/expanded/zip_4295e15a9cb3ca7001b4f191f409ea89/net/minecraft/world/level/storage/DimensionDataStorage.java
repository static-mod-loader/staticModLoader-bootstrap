...
public class DimensionDataStorage {
   ...
   private <T extends SavedData> T readSavedData(Function<CompoundTag, T> p_164869_, String p_164870_) {
      try {
         ...
         if (file1.exists()) {
            CompoundTag compoundtag = this.readTagFromDisk(p_164870_, SharedConstants.getCurrentVersion().getDataVersion().getVersion());
   ...
   public CompoundTag readTagFromDisk(String p_78159_, int p_78160_) throws IOException {
      ...
      try (
         ...
         compoundtag1 = DataFixTypes.SAVED_DATA.update(this.fixerUpper, compoundtag, i, p_78160_);
      }
