         ...
         if (flag || flag1) {
            ...
            if (j < list.size()) {
               ...
               if (flag) {
                  ...
                  p_64035_.explode((Entity)null, (double)((float)spikefeature$endspike.getCenterX() + 0.5F), (double)spikefeature$endspike.getHeight(), (double)((float)spikefeature$endspike.getCenterZ() + 0.5F), 5.0F, Level.ExplosionInteraction.BLOCK);
