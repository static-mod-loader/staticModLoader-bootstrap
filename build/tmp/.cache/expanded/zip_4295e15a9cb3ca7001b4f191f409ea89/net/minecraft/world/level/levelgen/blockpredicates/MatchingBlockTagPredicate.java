...
public class MatchingBlockTagPredicate extends StateTestingPredicate {
   ...
   public static final Codec<MatchingBlockTagPredicate> CODEC = RecordCodecBuilder.create((p_259003_) -> {
      return stateTestingCodec(p_259003_).and(TagKey.codec(Registries.BLOCK).fieldOf("tag").forGetter((p_204686_) -> {
