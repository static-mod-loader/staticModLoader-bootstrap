...
public class EnderDragon extends Mob implements Enemy {
   ...
   public void aiStep() {
      ...
      if (this.dragonFight == null) {
         Level $$6 = this.level();
         if ($$6 instanceof ServerLevel) {
            ServerLevel serverlevel = (ServerLevel)$$6;
      ...
      if (this.isDeadOrDying()) {
         ...
         if (this.isNoAi()) {
            ...
            for(int k = 0; k < 3; ++k) {
               ...
               this.tickPart(enderdragonpart, (double)(-(f1 * 1.5F + f18 * f22) * f13), adouble1[1] - adouble[1] - (double)((f22 + 1.5F) * f) + 1.5D, (double)((f15 * 1.5F + f20 * f22) * f13));
            }
   ...
   public void onCrystalDestroyed(EndCrystal p_31125_, BlockPos p_31126_, DamageSource p_31127_) {
      ...
      if (p_31125_ == this.nearestCrystal) {
         this.hurt(this.head, this.damageSources().explosion(p_31125_, player), 10.0F);
      }
