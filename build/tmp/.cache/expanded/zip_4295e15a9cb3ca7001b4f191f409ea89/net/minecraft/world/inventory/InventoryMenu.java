   ...
   public InventoryMenu(Inventory p_39706_, boolean p_39707_, final Player p_39708_) {
      ...
      for(int k = 0; k < 4; ++k) {
         ...
         this.addSlot(new Slot(p_39706_, 39 - k, 8, 8 + k * 18) {
            public void setByPlayer(ItemStack p_270969_) {
               InventoryMenu.onEquipItem(p_39708_, equipmentslot, p_270969_, this.getItem());
      ...
      this.addSlot(new Slot(p_39706_, 40, 77, 62) {
         public void setByPlayer(ItemStack p_270479_) {
            InventoryMenu.onEquipItem(p_39708_, EquipmentSlot.OFFHAND, p_270479_, this.getItem());
